...
<div class="hero-header">
    ...
    <p class="hero-subtitle">Thank you for being a part of LifeLine. Here is your medical contribution summary.</p>
</div>
        ...
        <div class="col-lg-8">
            ...
            <div class="premium-card mb-4 position-relative overflow-hidden" id="eligibility-card" style="display: none;">
                ...
                <div class="ps-3 border-start border-4" id="eligibility-container" style="border-color: #198754 !important;">
                    ...
                    <h2 class="font-heading my-2 text-dark" id="eligibility-title" style="font-size: 28px;">You are Eligible!</h2>
                ...
                <div class="col-md-6">
                    <div class="premium-card h-100">
                        ...
                        <p class="text-secondary" style="font-size: 13px; line-height: 1.6;">
                            Your blood donations act as a lifeline for clinical surgeries, accident victims, cancer patients, and pediatric operations across Sri Lanka. One bag of blood is processed into packed red blood cells, plasma, and platelets, which can help up to 3 individual patients.
                        </p>
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            if (isEligible) {
                ...
                subtitle.textContent = "Donation Status";
