...
try {
    ...
    // 2. Create database
    $dbName = getenv('DB_NAME') ?: 'blood_bank_db';
    $pdo->exec("CREATE DATABASE IF NOT EXISTS $dbName");
    $pdo->exec("USE $dbName");
    echo "<div class='alert alert-success'>Database '$dbName' created or verified.</div>";
    ...
    echo "<div class='alert alert-success'>Seeded 7 initial users successfully.</div>";
