...
<div class="premium-card mb-4">
    ...
    <div class="d-flex flex-column gap-2" id="sidebar-menu">
        <a href="<?php echo APP_URL; ?>/admin/dashboard.php" class="btn btn-pill text-start py-2 w-100 <?php echo $activeKey === 'dashboard' ? 'btn-crimson text-white' : 'btn-outline-light text-dark border-0'; ?>">
            <i class="bi bi-speedometer2 me-2"></i> Dashboard
        </a>
        <a href="<?php echo APP_URL; ?>/admin/users.php" class="btn btn-pill text-start py-2 w-100 <?php echo $activeKey === 'users' ? 'btn-crimson text-white' : 'btn-outline-light text-dark border-0'; ?>">
            <i class="bi bi-people-fill me-2"></i> Users Management
        </a>
        <a href="<?php echo APP_URL; ?>/admin/updaters.php" id="sidebar-updaters-link" class="btn btn-pill text-start py-2 w-100 <?php echo $activeKey === 'updaters' ? 'btn-crimson text-white' : 'btn-outline-light text-dark border-0'; ?>" style="display: none;">
            <i class="bi bi-hospital me-2"></i> Updater Management
        </a>
        <a href="<?php echo APP_URL; ?>/admin/superadmin.php" id="sidebar-superadmin-link" class="btn btn-pill text-start py-2 w-100 <?php echo $activeKey === 'superadmin' ? 'btn-crimson text-white' : 'btn-outline-light text-dark border-0'; ?>" style="display: none;">
            <i class="bi bi-shield-fill-check me-2"></i> Super Admin Panel
        </a>
        <a href="<?php echo APP_URL; ?>/admin/settings.php" class="btn btn-pill text-start py-2 w-100 <?php echo $activeKey === 'settings' ? 'btn-crimson text-white' : 'btn-outline-light text-dark border-0'; ?>">
            <i class="bi bi-sliders me-2"></i> Command / Settings
        </a>
        <a href="<?php echo APP_URL; ?>/admin/profile.php" class="btn btn-pill text-start py-2 w-100 <?php echo $activeKey === 'profile' ? 'btn-crimson text-white' : 'btn-outline-light text-dark border-0'; ?>">
            <i class="bi bi-person-fill me-2"></i> My Profile
        </a>
        <hr class="my-2">
        <button id="theme-toggle-btn" class="btn btn-pill text-start py-2 w-100 btn-outline-light text-dark border-0">
            <i id="theme-toggle-icon" class="bi bi-moon-fill me-2"></i> Toggle Theme
        </button>
        <a href="<?php echo APP_URL; ?>/home.php" class="btn btn-pill text-start py-2 w-100 btn-outline-light text-dark border-0">
