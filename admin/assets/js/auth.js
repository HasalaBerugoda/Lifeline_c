...
function checkAuth(allowedRoles = []) {
    ...
    // Redirect paths since we are inside a subdirectory
    const loginRedirect = 'login.php';
    const homeRedirect = '../home.php';
...
async function apiFetch(endpoint, options = {}) {
    ...
    // Prepend parent path since api is at root level
    const prefix = '../';
