                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-transparent border-end-0 text-muted"><i class="bi bi-person-fill"></i></span>
                                <input type="email" class="form-control border-start-0 ps-0" id="reply-to" readonly style="font-weight: 500;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-transparent border-end-0 text-muted"><i class="bi bi-chat-left-text-fill"></i></span>
                        ...
                        <div class="col-12">
                            ...
                            <div class="p-3 bg-light rounded shadow-sm" style="border: 1px solid var(--color-light-gray); border-left: 4px solid var(--color-crimson) !important;">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-transparent align-items-start pt-2 border-end-0 text-muted"><i class="bi bi-pencil-fill"></i></span>
