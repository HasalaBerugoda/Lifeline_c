        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled d-flex flex-column gap-2">
                    ...
                    <li><a href="donation-camps.php">Donation Camps</a></li>
                    <li><a href="contact-us.php">Contact Us</a></li>
                    <li><a href="index.php">Portal Sign In</a></li>
                </ul>
            </div>
            
            <div class="col-md-3">
                <h5 class="font-heading">System Setup</h5>
                <ul class="list-unstyled d-flex flex-column gap-2">
                    <li><a href="setup.php" class="text-warning"><i class="bi bi-tools me-1"></i>Initialize Database</a></li>
                    <li class="text-white-50"><i class="bi bi-geo-alt me-1"></i>Colombo, Sri Lanka</li>
                    <li class="text-white-50"><i class="bi bi-envelope me-1"></i>support@lifeline.lk</li>
                </ul>
            </div>
        </div>
        <hr class="my-4 border-secondary opacity-25">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center text-white-50">
            <p class="mb-0">&copy; <?php echo date('Y'); ?> LifeLine Blood Bank Management System. All rights reserved.</p>
