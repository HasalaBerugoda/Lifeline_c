                        ...
                        <div style='max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);'>
                            ...
                            <div style='padding: 30px;'>
                                ...
                                <div style='text-align: center; margin-top: 30px;'>
                                    <a href='" . APP_URL . "/donation-camps.php' style='background-color: #e63946; color: #ffffff; text-decoration: none; padding: 12px 30px; font-size: 16px; font-weight: bold; border-radius: 30px; display: inline-block; box-shadow: 0 4px 6px rgba(230, 57, 70, 0.2);'>Register for Camp</a>
                                </div>
                            </div>
